...
export const CHAPTERS = {
    ...
    '9_tar': [
        {
            id: 'ch1',
            name: 'سورۃ نمبر 1: سُورَۃُ مَریَمِ',
            topics: [
                { id: 'ch1_t1', name: 'سُورَۃُ مَریَمِ' }
            ]
        },
        {
            id: 'ch2',
            name: 'سورۃ نمبر 2: سُورَۃُ طٰہٰ',
            topics: [
                { id: 'ch2_t1', name: 'سُورَۃُ طٰہٰ' }
            ]
        },
        {
            id: 'ch3',
            name: 'سورۃ نمبر 3: سُورَۃُ الاَنبِیَاءِ',
            topics: [
                { id: 'ch3_t1', name: 'سُورَۃُ الاَنبِیَاءِ' }
            ]
        },
        {
            id: 'ch4',
            name: 'سورۃ نمبر 4: سُورَۃُ الَحَجّ',
            topics: [
                { id: 'ch4_t1', name: 'سُورَۃُ الَحَجّ' }
            ]
        },
        {
            id: 'ch5',
            name: 'سورۃ نمبر 5: سُورَۃُ الفُرقَانَ',
            topics: [
                { id: 'ch5_t1', name: 'سُورَۃُ الفُرقَانَ' }
            ]
        },
        {
            id: 'ch6',
            name: 'سورۃ نمبر 6: سُورَۃُ الشّعَرَآءِ',
            topics: [
                { id: 'ch6_t1', name: 'سُورَۃُ الشّعَرَآءِ' }
            ]
        },
        {
            id: 'ch7',
            name: 'سورۃ نمبر 7: سُورَۃُ النُّملِ',
            topics: [
                { id: 'ch7_t1', name: 'سُورَۃُ النُّملِ' }
            ]
        },
        {
            id: 'ch8',
            name: 'سورۃ نمبر 8: سُورَۃُ القَصَصِ',
            topics: [
                { id: 'ch8_t1', name: 'سُورَۃُ القَصَصِ' }
            ]
        },
        {
            id: 'ch9',
            name: 'سورۃ نمبر 9: سُورَۃُ العَنکَبُوتَ',
            topics: [
                { id: 'ch9_t1', name: 'سُورَۃُ العَنکَبُوتَ' }
            ]
        },
        {
            id: 'ch10',
            name: 'سورۃ نمبر 10: سُورَۃُ الرُّومہِ',
            topics: [
                { id: 'ch10_t1', name: 'سُورَۃُ الرُّومہِ' }
            ]
        },
        {
            id: 'ch11',
            name: 'سورۃ نمبر 11: سُورَۃُ لُقمنَ',
            topics: [
                { id: 'ch11_t1', name: 'سُورَۃُ لُقمنَ' }
            ]
        },
        {
            id: 'ch12',
            name: 'سورۃ نمبر 12: سُورَۃُ السَّجدَۃِ',
            topics: [
                { id: 'ch12_t1', name: 'سُورَۃُ السَّجدَۃِ' }
            ]
        },
        {
            id: 'ch13',
            name: 'سورۃ نمبر 13: سُورَۃُ سَبَاِِ',
            topics: [
                { id: 'ch13_t1', name: 'سُورَۃُ سَبَاِِ' }
            ]
        },
        {
            id: 'ch14',
            name: 'سورۃ نمبر 14: سُورَۃُ فَاطِرِِ',
            topics: [
                { id: 'ch14_t1', name: 'سُورَۃُ فَاطِرِِ' }
            ]
        },
        {
            id: 'ch15',
            name: 'سورۃ نمبر 15: سُورَۃُ یَس',
            topics: [
                { id: 'ch15_t1', name: 'سُورَۃُ یَس' }
            ]
        },
        {
            id: 'ch16',
            name: 'سورۃ نمبر 16: سُورَۃُ الصّٰفّٰتِ',
            topics: [
                { id: 'ch16_t1', name: 'سُورَۃُ الصّٰفّٰتِ' }
            ]
        },
        {
            id: 'ch17',
            name: 'سورۃ نمبر 17: سُورَۃُ صٓ',
            topics: [
                { id: 'ch17_t1', name: 'سُورَۃُ صٓ' }
            ]
        },
        {
            id: 'ch18',
            name: 'سورۃ نمبر 18: سُورَۃُ الاَحقَافِ',
            topics: [
                { id: 'ch18_t1', name: 'سُورَۃُ الاَحقَافِ' }
            ]
        }
    ],
    '9_isl': [
